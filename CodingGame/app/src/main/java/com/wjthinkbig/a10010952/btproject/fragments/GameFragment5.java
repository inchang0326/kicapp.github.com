...
public class GameFragment5 extends Fragment {
    ...
    public GameFragment5(Context c, IFragmentListener l) {
        mContext = c;
        mFragmentListener = l;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        m_down = (ImageView) mRootView.findViewById(R.id.down);
        ...
        m_back = (Button) mRootView.findViewById(R.id.back);
        m_clear = (Button) mRootView.findViewById(R.id.clear);
        m_run = (Button) mRootView.findViewById(R.id.run);
        m_codingStation = (GridView) mRootView.findViewById(R.id.codingStation);
        m_codingStationAdapter = new GridViewAdapter(mContext.getApplicationContext(), R.layout.gridview_item, m_stackForCodingStation);
        ...
        m_dingco = (ImageView) mRootView.findViewById(R.id.dingco);

        // 레이아웃 모음
        m_alphaMapContainer = (TableLayout) mRootView.findViewById(R.id.tableLayout);
        m_dingcoContainer = (RelativeLayout) mRootView.findViewById(R.id.dingcocontainer);
        ...
        final ViewGroup transitionsContainer = (ViewGroup) mRootView.findViewById(R.id.transition);
            ...
            switch (v.getId()) {
                ...
                case R.id.run: {
                    ...
                    if (m_queueForCodingBlock.isEmpty()) {
                        ...
                        new MovingTask5(GameFragment5.this).execute(new MovingTaskParams(m_queueForMovingTask, m_queueForMovingTask.size()));
                    }
                    // 알파벳을 모두 맞추었으면
    ...
    */
    ...
    public void setAlphabetImage(char alpha) {
        m_alphabet.setVisibility(View.VISIBLE);
        String temp = String.valueOf(alpha);
        Alphabets alphabets = Alphabets.valueOf(temp);
        m_alphabet.setImageResource(alphabets.getDrawableId());
    }
}
