...
public class GameFragment extends Fragment {
                ...
                switch (v.getId()) {
                    ...
                    case R.id.run: {
                        ...
                        if (m_queueForCodingBlock.isEmpty()) {
                            ...
                            while(queueToArduino.size() > 0) {
                                Arrow temp = queueToArduino.poll();
                                switch (temp) {
                                    case up : {
                                        if(m_prevArrow != null) {
                                            sendMessage("fffff\nffff");
                                            ...
                                            Log.d("inchang", "앞");
                                            if(m_prevArrow == Arrow.up) {
                                                sendMessage("앞");
                                            } else if(m_prevArrow == Arrow.down) {
                                                sendMessage("앞");
                                            } else if(m_prevArrow == Arrow.left) {
                                                sendMessage("오른쪽\n앞");
                                            } else if(m_prevArrow == Arrow.right) {
                                                sendMessage("왼쪽\n앞");
                                            }
                                        }
                                        break;
    ...
    */
    ...
    private void correctMsgToArduino() {
        sendMessage("끄기\n초록\n정답");
    }
}
