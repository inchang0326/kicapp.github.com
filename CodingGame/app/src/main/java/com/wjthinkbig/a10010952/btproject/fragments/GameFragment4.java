...
public class GameFragment4 extends Fragment {
    ...
    public GameFragment4(Context c, IFragmentListener l) {
        mContext = c;
        mFragmentListener = l;
            ...
            switch (v.getId()) {
                ...
                case R.id.run: {
                    ...
                    if (m_queueForCodingBlock.isEmpty()) {
                        ...
                        new MovingTask4(GameFragment4.this).execute(new MovingTaskParams(m_queueForMovingTask, m_queueForMovingTask.size()));
                    }
                    // 알파벳을 모두 맞추었으면
