...
public class ViewActivity extends Activity {
    ...
    private void displayMap() {
        ...
        RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(150, 150);
        switch (m_mapInfo) {
            case 3: {
                rl.setMargins(250, 230, 0, 0);
                m_relativeLayout.addView(m_dingco, rl);
                break;
            }
            case 4: {
                rl.setMargins(215, 160, 0, 0);
                m_relativeLayout.addView(m_dingco, rl);
                break;
            }
            case 5: {
                rl.setMargins(195, 85, 0, 0);
                m_relativeLayout.addView(m_dingco, rl);
                break;
            }
        }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.clear: {                  // 게임 정보 초기화
                    ...
                    m_stackForAnswers.clear();      // 스택 데이터 제거
